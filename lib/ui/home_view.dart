...
import 'package:real_you/main.dart';
...
import 'package:real_you/ui/test_image_convert.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        ...
        children: [Text(left, style: TextStyle(color: Colors.white),), Text(right, style: TextStyle(color: Colors.white),),],
      ),
    );
  }
}
